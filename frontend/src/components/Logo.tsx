...
/** Marca completa de Telar: dos urdimbres y dos tramas entrelazadas, con el
 * hilo coral saliendo por la derecha. viewBox de origen: 9 15 105 94. */
...
/**
 * Logo de Telar. `mark`/`icon` heredan currentColor para el trazo (controlalo
 * desde el contenedor con className de texto); solo el hilo coral queda fijo
 * salvo que pases `accent="currentColor"` para una tinta plana.
 *
 *   <Logo variant="horizontal" size={32} />  // header
 *   <Logo variant="mark" size={40} />        // sidebar colapsado
 *   <Logo variant="icon" size={20} />        // badges, nodos, inline
